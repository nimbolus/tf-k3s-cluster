...
module "secgroup" {
  source = "git::https://github.com/nimbolus/tf-k3s.git//k3s-openstack/security-group?ref=v4.1.1"
...
module "server1" {
  source = "git::https://github.com/nimbolus/tf-k3s.git//k3s-openstack?ref=v4.1.1"
